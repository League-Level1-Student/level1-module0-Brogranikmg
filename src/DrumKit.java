...
public class DrumKit implements MouseListener {
    ...
    private void getGoing() throws MalformedURLException {
   	 ...
   	 JFrame ddrum = new JFrame();
   	 // 2. Make the frame visible and 
    //     set its default close operation to JFrame.EXIT_ON_CLOSE
   	 ddrum.setVisible(true);
   	 ddrum.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
   	 // 3. Set the size of the frame
   	 ddrum.setSize(500, 400);
   	 // 4. Set the title of the frame
   	 ddrum.setTitle("It's drum time.");
   	 // 5. Make a JPanel variable and initialize it using "new JPanel().
   	 JPanel earwax = new JPanel();
     ...
     String destroyed = "drumdrum.png";
   	 // 9. Edit the next line to use your String variable
// drumLabelWithImage = createLabelImage(drumImageString);
     drumLabelWithImage = createLabelImage(destroyed);
   	 // 10. Add the image to the panel
     earwax.add(drumLabelWithImage);
   	 // 11. Set the layout of the panel to "new GridLayout()"
     earwax.setLayout(new GridLayout());
